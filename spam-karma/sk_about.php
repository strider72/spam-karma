...
<p><?php _e('Kind words of support or constructive comments are always welcome as well. Please use this <a href="http://unknowngenius.com/blog/wordpress/spam-karma/sk-contact-form/">online form</a> to contact me.', 'spam-karma'); ?></p>
...
<p><?php
	...
	echo "</p><p><em>Please email me your name+URL+language if you have contributed to SK's l10n effort</em>";
?>
</p></fieldset>

<fieldset class="sk_cast"><legend><b><?php _e("Fearless Guinea Pigs, Generous Souls and All Around Cool People", 'spam-karma'); ?></b></legend>
<p><?php
...
<p style="text-indent:0;"><em><small><?php _e('Did I leave you out? please do let me know... I\'ve done my best to ensure I had the whole team covered, but I might have missed a few, so don\'t hesitate to <a href="http://unknowngenius.com/blog/wordpress/spam-karma/sk-contact-form/">contact me</a>.', 'spam-karma'); ?></small></em></p>
</div>